...
## 1. Purpose & Overview
Internal platform documentation for super admins.

## 2. User Flow & Navigation
- **Entry Point**: Sidebar > Documentation
...
- **Page Header**: Distinct Title, Breadcrumb (Super Admin > Documentation).
- **Layout Type**: Custom SaaS Layout optimized for high-density data.
- **Widgets / Sections**: Focuses on Markdown Viewer.

## 4. Key UI Components
- **Core Elements**: Markdown Viewer, Navigation Tree
...
- **Granular Permissions**: `super_admin:documentation:read`, `super_admin:documentation:write`
