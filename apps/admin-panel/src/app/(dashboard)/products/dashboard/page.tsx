...
import { PageHeader, Card, CardHeader, CardTitle, CardContent } from "@commercex/ui";
  ...
  return (
    <div className="space-y-6">
      <PageHeader 
        ...
        text="Overview of your catalog performance and inventory alerts."
      />
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">Units sold in last 30 days</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">Recurring revenue items</p>
          </CardContent>
        </Card>
      </div>
    </div>
