    ...
    return [
      {
        ...
        headers: [
          ...
          { key: 'X-Frame-Options', value: 'DENY' }, // Important for admin panel to prevent clickjacking
          { key: 'X-Content-Type-Options', value: 'nosniff' },
          { key: 'Referrer-Policy', value: 'origin-when-cross-origin' },
          { key: 'Permissions-Policy', value: 'camera=(), microphone=(), geolocation=()' },
          { 
            key: 'Content-Security-Policy', 
            // Admin panel can afford to be stricter, but we still allow inline styles for Tailwind/React
